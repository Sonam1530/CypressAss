...
describe('Incubyte Assessment', () => {
    it('Cypress Automation', () => {
      ...
      cy.wait (500)
      cy.get('#email_address').type('ssvrkr0412@gmail.com')
      cy.wait (500)
      cy.get('#password').type('ssvrkr@0412')
      cy.wait (500)
      cy.get('#password-confirmation').type('ssvrkr@0412')
      cy.wait (500)
      ...
      cy.wait (4000)
      cy.get('#email').type('ssvrkr0412@gmail.com')
      cy.get('.login-container > .block-customer-login > .block-content > #login-form > .fieldset > .password > .control > #pass').type('ssvrkr@0412')
